...
- Reduced the latest 4-case live smoke sample from prior `schema_repair=6/schema_fallback=6` to `schema_repair=0/schema_fallback=0/placeholder_clean=0`; then verified the full 8x3 live sample at `repair_reliance_rate=0.083`, below the V6 target of 0.2.
## 2026-06-16

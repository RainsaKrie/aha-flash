...
const FLOW_FOLLOW_UPS: Record<string, FollowUpTopic[]> = {
  ...
  "dns-router": [
    ...
    },
    {
      ...
      title: "追一次链路诊断",
      concept: "网络链路诊断",
      hook: "请求卡住时，怎样一步步定位问题？",
      relation: "从正常寻址走向故障排查",
      kind: "ai_seed",
      suggestedPattern: "process_timeline",
    },
    {
      id: "dns-to-industrial",
      title: "拆一个生产系统",
      concept: "工业革命",
      hook: "换到历史里看看系统协作如何放大效率。",
      relation: "从网络协作走向社会协作",
      kind: "curated",
      target_flow_id: "industrial-revolution",
    },
  ],
  "options-risk": [
    {
      ...
      title: "回到概率判断",
      concept: "贝叶斯定理",
      hook: "不确定性里，先看新信息怎样改判断。",
      relation: "从未来选择权走向证据更新",
      kind: "curated",
      target_flow_id: "bayes-starter",
    },
    {
      id: "options-to-inflation",
      title: "接到价格预期",
      concept: "通胀 vs 通缩",
      hook: "价格预期变化时，选择权的价值也会变。",
      relation: "从个体风险走向市场预期",
      kind: "curated",
      target_flow_id: "inflation-deflation",
    },
    {
      id: "options-to-marginal",
      title: "看下一步值不值",
      concept: "边际效应",
      hook: "继续持有、行权或放弃，都在问下一步是否值得。",
      relation: "从有限亏损走向边际选择",
      kind: "curated",
